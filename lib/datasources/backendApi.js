...
exports.EVENTS = {
	...
	UserLogin: function(cb) {
		var loginData = {
			email: CONFIG.platformCredentials.email,
	...
	/**
     * Get filtered data for any model
     */
    GetFilteredData: function(model, filter, access_token, cb) {
        HTTP({
            url: CONFIG.backend_api_url+'/'+model+'?filter='+JSON.stringify(filter)+'&access_token=' + access_token,
            method: 'GET',
            json: true
        },function(error, response, body) {
